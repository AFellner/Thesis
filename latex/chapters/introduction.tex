...
For example \cite{Konev2014} reports of a 13GB proof of the Erd\H{o}s Discrepancy Conjecture, written in the DRUP proof format, which prints as little information as possible.
...
using the four axioms \emph{reflexivity}, \emph{symmetry}, \emph{transitivity} and \emph{compatability}. 
...
Deep Inference \cite{TODO: deep inference; http://vsl2014.at/meetings/APPA-index.html} combines a number of approaches to formulate new proof systems, which can represent proofs much more succinctly than traditional systems.
