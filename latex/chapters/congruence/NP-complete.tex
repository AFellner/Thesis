...
Our proof of NP-completeness reduces the problem of deciding the satisfiability of a propositional logic formula  in conjunctive normal form, which is commonly abbreviated with SAT, to the short explanation decision problem.
