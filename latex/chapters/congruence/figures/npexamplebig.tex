...
\node[right =3.4cm of f11] (f21) {$f_2(\bot_1)$};
\node[right =3.4cm of t11] (t21) {$t_2(\top_1)$};
\node[right =3.4cm of t12] (t22) {$t_2(\top_2)$};
\node[right =3.4cm of f12] (f22) {$f_2(\bot_2)$};
\node[right =3.4cm of t13] (t23) {$t_2(\top_3)$};
\node[right =3.4cm of f13] (f23) {$f_2(\bot_3)$};
