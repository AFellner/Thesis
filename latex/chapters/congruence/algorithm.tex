...
{\color{blue} Do I cite \cite{Nieuwenhuis2005,Nieuwenhuis2007} too often? Should I only cite their newer paper?}
...
{\color{blue}Add equations from example \ref{ex:short_expl} with d - terms first into structure and show why equation graph produces longer proof.}
